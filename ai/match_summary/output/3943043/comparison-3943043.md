...
Chosen from the 5-cell comparison on match 3943043 (`ai/match_summary/output/3943043/comparison-3943043.md`). Each cell is n = 1 and errors were called out by manual read, not a scored eval, so this is a **default to revisit once the eval system (Module 3) exists**, not a conclusion.
...
**Chosen routing:** outcome → cell 4, tactics → cell 3 (a default, to revisit once the eval system exists).
