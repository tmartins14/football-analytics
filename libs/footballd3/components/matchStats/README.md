...
**Produced by:** `libs/statsbomb/extract_match_stats.py`
...
```bash
uv run libs/statsbomb/extract_match_stats.py
# Writes: libs/footballd3/sample_data/match_stats_3943043.json
```
