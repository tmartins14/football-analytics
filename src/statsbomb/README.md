...
and writes the JSON contract to `src/footballd3/sample_data/`.
...
**Output:** `src/footballd3/sample_data/shots_{match_id}.json`
...
**Output:** `src/footballd3/sample_data/progressive_map_{match_id}_{team_slug}.json`
...
**Output:** `src/footballd3/sample_data/possession_{match_id}_{possession_id}.json`
...
**Output:** `src/footballd3/sample_data/heatmap_{match_id}_{player_slug}.json`
...
**Output:** `src/footballd3/sample_data/pass_network_{match_id}_{team_slug}.json`
...
**Output:** `src/footballd3/sample_data/momentum_{match_id}.json`
...
**Output:** `src/footballd3/sample_data/goal_animation_{match_id}.json`
...
**Output:** `src/footballd3/sample_data/match_stats_{match_id}.json`
...
uv run python src/statsbomb/extract_formation.py
uv run python src/statsbomb/extract_team_shape.py
uv run python src/statsbomb/extract_xt.py       # must run before extract_momentum
uv run python src/statsbomb/extract_momentum.py
uv run python src/statsbomb/extract_goal_animation.py
uv run python src/statsbomb/extract_match_stats.py
```
